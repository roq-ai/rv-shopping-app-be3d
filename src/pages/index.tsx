...
function HomePage() {
  return (
    <>
      <Head>
        <title>{`RV Shopping App`}</title>

        <meta
          name="description"
          content="Experience the new era of online shopping with RV Shopping App. Discover a variety of clothes, brands, sizes, and colors with exciting festive sales."
        />
      </Head>
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1483985988355-763728e1935b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxzaG9wcGluZ3xlbnwwfHx8fDE2OTMyODgyMTF8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience the new era of online shopping with RV Shopping App. Discover a variety of clothes, brands, sizes, and colors with exciting festive sales.`}
            </Text>
            <Box
