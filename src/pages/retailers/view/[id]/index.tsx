...
import { getRetailerById } from 'apiSdk/retailers';
import { RetailerInterface } from 'interfaces/retailer';
import { ProductListPage } from 'pages/products';

function RetailerViewPage() {
            ...
            <FormWrapper wrapperProps={{ gap: 3, p: 4 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('retailer', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/retailers/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              <EntityImage entity="retailer" entityId={id} />
              <List
                w="100%"
                css={{
                  '> li:not(:last-child)': {
