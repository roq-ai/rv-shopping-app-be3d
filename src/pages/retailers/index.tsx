...
type ColumnType = ColumnDef<RetailerInterface, unknown>;
...
export function RetailerListPage(props: RetailerListPageProps) {
  const {
    filters = {},
    titleProps = {},
  ...
  const { data, error, isLoading, mutate } = useSWR<PaginatedInterface<RetailerInterface>>(
    () => `/retailers?params=${JSON.stringify(params)}`,
    fetcher,
  );
      ...
      ? {
          ...
          cell: ({ row: { original: record } }: any) => (
            <Flex justifyContent="flex-end">
              <NextLink href={`/retailers/view/${record.id}`} passHref legacyBehavior>
                <Button
