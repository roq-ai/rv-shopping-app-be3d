...
export function ProductListPage(props: ProductListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getProducts({
        relations: ['retailer', 'cart_item.count', 'sale.count'],
        limit: params.pageSize,
        offset: params.pageNumber * params.pageSize,
        searchTerm: params.searchTerm,
        order: params.order,
        searchTermKeys: ['name.contains', 'brand.contains', 'size.contains', 'color.contains'],
        ...(params.filters || {}),
      }),
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('retailer', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'retailer',
          header: 'Retailer',
          accessorKey: 'retailer',
          cell: ({ row: { original: record } }: any) => (
            <Link as={NextLink} onClick={(e) => e.stopPropagation()} href={`/retailers/view/${record.retailer?.id}`}>
